...
./build/compare_lcnn_kernels_cuda \
  ...
  --gen.af-device=0 \
  --gen.output-csv=./log/compare-${TOPO}-8000-kernels-gallancchio-narma10.csv \
  --opt.cmaes-fplot=./log/compare-${TOPO}-8000-kernels-gallancchio-narma10-run@RUN@.dat \
  2>&1 | tee ./log/compare-${TOPO}-8000-kernels-gallancchio-narma10.log
