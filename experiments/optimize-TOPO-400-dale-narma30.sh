...
./build/optimize_cpu \
  ...
  --gen.af-device=1 \
  --gen.output-csv=./log/optimize-${TOPO}-400-dale-narma30.csv \
  --opt.cmaes-fplot=./log/optimize-${TOPO}-400-dale-narma30-run@RUN@.dat \
  2>&1 | tee ./log/optimize-${TOPO}-400-dale-narma30.log
