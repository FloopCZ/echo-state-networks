...
./build/optimize_cuda \
  ...
  --opt.exclude-params=lcnn.sigma-b lcnn.noise lcnn.sparsity lcnn.train-valid-ratio lcnn.mu-in-weight lcnn.mu-fb-weight lcnn.sigma-fb-weight lcnn.input-to-n lcnn.n-state-predictors lcnn.memory-prob lcnn.adapt.abs-target-activation \
